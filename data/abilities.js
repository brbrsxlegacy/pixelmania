(function () {
  ...
  window.LUMA_DATA.abilities = {
    ...
    magmaYumrugu: { id: "magmaYumrugu", name: "Magma Yumruğu", element: "Alev", power: 54, accuracy: 90, pp: 14, animation: "magma", effect: { type: "burn", chance: .2 }, description: "Erimiş taşla ağır bir yakın vuruş." },
    lavAkisi: { id: "lavAkisi", name: "Lav Akışı", element: "Alev", power: 66, accuracy: 82, pp: 9, animation: "lava", effect: { type: "slow", chance: .2 }, description: "Zemini kızdırıp rakibin hızını kırar." },
    korFirtinasi: { id: "korFirtinasi", name: "Kor Fırtınası", element: "Alev", power: 72, accuracy: 78, pp: 7, animation: "emberstorm", effect: { type: "burn", chance: .3 }, description: "Köz parçalarıyla riskli ama sert bir saldırı." },
    volkanKukremesi: { id: "volkanKukremesi", name: "Volkan Kükremesi", element: "Alev", power: 0, accuracy: 100, pp: 8, animation: "roar", effect: { type: "attackUp", chance: 1 }, description: "Prime öncesi iç ateşi büyüten korkusuz kükreme." },
